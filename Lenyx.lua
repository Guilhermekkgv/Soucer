...
function LinuxLib.Tab(config)
    ...
    function TabElements.Toggle(config)
        ...
        Toggle.MouseLeave:Connect(function()
            local currentState = Toggle:GetAttribute("State")
        ...
        local function UpdateToggle(thisToggle)
            ...
            if thisTrack and thisKnob and thisText then
                ...
                if currentState then
                    ...
                    TweenService:Create(thisText, tween, {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                else
            ...
            if IsOpen then
                for i, opt in pairs(Options) do
                    ...
                    OptBtn.MouseLeave:Connect(function()
                        local currentSelected = IsMulti and table.find(SelectedValues, opt) or opt == SelectedValue
                        if currentSelected then
                            TweenService:Create(OptBtn, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
                        else
                            TweenService:Create(OptBtn, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(200, 200, 210)}):Play()
                        end
                    end)
    ...
    function TabElements.Paragraph(config)
        ...
        ParagraphFrame.MouseEnter:Connect(function()
            ...
            TweenService:Create(Content, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)
        ...
        ParagraphFrame.MouseLeave:Connect(function()
            ...
            TweenService:Create(Content, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(150, 150, 155)}):Play()
        end)
    ...
    function TabElements.Notification(config)
        ...
        NotificationFrame.MouseEnter:Connect(function()
            ...
            TweenService:Create(NotificationText, TweenInfo.new(0.2), {TextColor3 = Color3.fromRGB(255, 255, 255)}):Play()
        end)
    ...
    function TabElements.Colorpicker(config)
        ...
        spawn(function() Linux:SafeCallback(config.
            end
        end
